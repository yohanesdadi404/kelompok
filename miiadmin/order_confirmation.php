...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand"><img src="../logo/Logoo2.png" /></a>
			</div>
				...
				<div id="divToPrint">
					<div class="row" style="margin-bottom: 10px;">
						<div class="col-lg-12" style="margin-bottom:40px;">
							<div class="col-xs-6">
								<img class="logo-img" src="../logo/Logoo.png" />
							</div>
							<div class="col-xs-6 text-right" style="margin-top: 10px;">
								<address>
								Jl. Universitas Perjuangan Tasikmalaya<br/>
								Telepon : 087654321<br/>
								Email : 2003010040@unper.ac.id
								</address>
							</div>
							<?php
	...
	<footer class="footer-bottom">
		<div class="footer-right">
			&copy; 2023 FAYOAR | Design by Victory Webstore
		</div>
		<div class="clearfix"></div>
	</footer>
