				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="fname" placeholder="Masukan isi nama Anda" value="<?php echo isset($fname) ? $fname : ' ';?>">
							<span class="text-danger msg-error"><?php echo $fnameErr; ?></span>
						</div>
							
						<div class="col-sm-6 form-group">
							<label>Nama Terakhir :</label>
							<input type="text" class="form-control" name="lname" placeholder="Masukan isi nama Anda" value="<?php echo isset($lname) ? $lname : ' ';?>">
					...
					<div class="row">
						<div class="col-sm-12 form-group">
							<label>Alamat :</label>
							<input type="text" class="form-control" name="address" placeholder="Masukan isi alamat" value="<?php echo isset($address) ? $address : ' ';?>">
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="city" placeholder="Masukan isi nama kota atau kabupaten" value="<?php echo isset($city) ? $city : ' ';?>">
							<span class="text-danger msg-error"><?php echo $cityErr; ?></span>
						</div>
							
						<div class="col-sm-6 form-group">
							<label>Provinsi :</label>
							<input type="text" class="form-control" name="state" placeholder="Masukan isi provinsi" value="<?php echo isset($state) ? $state : ' ';?>">
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="postcode" placeholder="Masukan isi kode pos" value="<?php echo isset($zip) ? $zip : ' ';?>">
							<span class="text-danger msg-error"><?php echo $zipErr; ?></span>
						</div>
							
						<div class="col-sm-6 form-group">
							<label>Phone Number :</label>
							<input type="text" class="form-control" name="phone" maxlength="14" placeholder="Masukan isi nomor telepon Anda" value="+62">
					...
					<div class="row">
						<div class="col-sm-4 form-group">
							...
							<input type="text" class="form-control" name="email" placeholder="Masukan isi alamat email" value="<?php echo isset($email) ? $email : ' ';?>">
							<span>Example: yourname@mail.com</span><br/>
							<span class="text-danger msg-error"><?php echo $emailErr; ?></span>
						</div>
						<div class="col-sm-4 form-group">
							<label>Kata Sandi :</label>
							<input type="password" class="form-control" name="pass" placeholder="Masukan kata sandi sini">
							<span class="text-danger msg-error"><?php echo $passErr; ?></span>
						</div>
						<div class="col-sm-4 form-group">
							<label>Konfirmasi Kata Sandi :</label>
							<input type="password" class="form-control" name="cpass" placeholder="Masukan kata sandi lagi">
