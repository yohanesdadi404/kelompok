...
<header class="page-header-two">
	<div class="container-fluid text-center">
		...
		<div class="col-md-4 top-header-middle">
			<img class="logo-header" src="../logo/Logoo.png" />
		</div>
					...
					<ul class="dropdown-menu mega-dropdown-menu">
						...
						<li class="col-sm-3 hidden-xs">
							<ul>
								...
								<img src="../assets/img/b15.png" alt="men-collection">
							</ul>
						</li>
					</ul>
				</li>
					...
					<ul class="dropdown-menu mega-dropdown-menu">
						...
						<li class="col-sm-3 hidden-xs">
							<ul>
								...
								<img src="../assets/img/b15.png" alt="women-collection">
							</ul>
						</li>
					</ul>
				</li>
					...
					<ul class="dropdown-menu mega-dropdown-menu">
						...
						<li class="col-sm-3 hidden-xs">
							<ul>
								...
								<img src="../assets/img/b15.png" alt="kid-collection">
							</ul>
						</li>
					</ul>
				</li>
