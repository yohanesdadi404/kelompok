		...
		<div class="core-slider_viewport">
			<div class="core-slider_list">
				<div class="core-slider_item">
					<img src="../assets/img/b11.jpg" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/b12.jpg" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/b13.jpg" alt="">
				</div>
				<div class="core-slider_item">
					<img src="../assets/img/b14.jpg" alt="">
				</div>
			</div>
		</div>
...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-4 col-sm-6 text-center">
			...
			<p>Konsultasi Online memungkinkan pengguna dapat menerima petunjuk dari pemakaian Aplikasi FAYOARstore</p>
		</div>
		...
		<div class="col-lg-4 col-sm-6 text-center">
			...
			<p>Gratis Ongkir ke seluruh Indonesia bersama mitra kami JNE dan JNT</p>
		</div>
		...
		<div class="col-lg-4 col-sm-6 text-center">
			...
			<h4 class="text2"><b>Garansi 100% kembali uang</b></h4>
			<p>Jaminan 100% uang kembali di setiap pembelian yang tidak sesuai aturan</p>
		</div>
	</div>
</div>
<div class="clearfix"></div>
...
<div class="container-fluid brands"><!-- <div class="container-fluid hidden-xs"> -->
	<div class="row">
		<div class="col-md-12 text-center"><h2 class="text-center text1">Beberapa Brand di toko kami</h2></div>
